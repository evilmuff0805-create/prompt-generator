...
const DURATION_CUE_RE = /3\s*seconds|~3s|over\s+\d+/i;
...
async function fetchReferenceImages(refIds, userId) {
  ...
  for (const row of rows) {
    ...
    dataUrls.push(`data:${mimeType};base64,${b64}`);
  }
