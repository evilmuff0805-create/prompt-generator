...
function buildGridPrompt(data, style, cutCount) {
  ...
  return `Create a ${cutCount === 9 ? '3×3' : '2×2'} storyboard grid image. ${cutCount} panels arranged left-to-right, top-to-bottom. Each panel shows a distinct cinematic shot. ${styleDirective} 16:9 aspect ratio per panel. No text, labels, or numbers in the image. High quality.
