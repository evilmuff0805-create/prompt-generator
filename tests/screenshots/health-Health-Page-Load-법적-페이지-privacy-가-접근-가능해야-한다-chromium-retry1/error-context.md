...
- Name: health.spec.js >> Health & Page Load >> 법적 페이지(privacy)가 접근 가능해야 한다
- Location: tests\e2e\health.spec.js:51:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/privacy.html
Call log:
  - navigating to "http://localhost:3000/privacy.html", waiting until "load"
