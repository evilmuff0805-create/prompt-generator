...
- Name: health.spec.js >> Health & Page Load >> 갤러리 페이지가 정상 로드되어야 한다
- Location: tests\e2e\health.spec.js:41:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/#gallery
Call log:
  - navigating to "http://localhost:3000/#gallery", waiting until "load"
